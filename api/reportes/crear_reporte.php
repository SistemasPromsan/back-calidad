...
if (
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO reportes (
            id_usuario, fecha, id_turno, id_inspector, id_num_parte, descripcion,
            plataforma, proveedor, id_cargo, lpn, lote_proveedor, cantidad_inspeccionada,
            cantidad_correcta, cantidad_retrabajo, cantidad_rechazada,
            horas, minutos, total_horas, motivo_inspeccion, defectos, observaciones
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        echo json_encode(["mensaje" => "Reporte creado exitosamente"]);
